...
type Server struct {
	...
	Report *Server_NetConfig `protobuf:"bytes,1,opt,name=report,proto3" json:"report,omitempty"`
	Notify *Server_NetConfig `protobuf:"bytes,2,opt,name=notify,proto3" json:"notify,omitempty"`
	Proxy  *Server_NetConfig `protobuf:"bytes,3,opt,name=proxy,proto3" json:"proxy,omitempty"`
}
...
func (x *Server) GetReport() *Server_NetConfig {
	if x != nil {
		return x.Report
	}
	return nil
...
func (x *Server) GetNotify() *Server_NetConfig {
	if x != nil {
		return x.Notify
	}
	return nil
...
func (x *Server) GetProxy() *Server_NetConfig {
	if x != nil {
		return x.Proxy
	}
	return nil
...
func (x *Server_NetConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_NetConfig) ProtoMessage() {}

func (x *Server_NetConfig) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_NetConfig.ProtoReflect.Descriptor instead.
func (*Server_NetConfig) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{1, 0}
}

func (x *Server_NetConfig) GetNetwork() string {
	if x != nil {
		return x.Network
	}
	return ""
...
func (x *Server_NetConfig) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *Server_NetConfig) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	,
	...
	0x42, 0x1a, 0x5a, 0x18, 0x71, 0x71, 0x62, 0x6f, 0x74, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server_NetConfig)(nil),    // 3: kratos.api.Server.NetConfig
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	3,  // 2: kratos.api.Server.report:type_name -> kratos.api.Server.NetConfig
	3,  // 3: kratos.api.Server.notify:type_name -> kratos.api.Server.NetConfig
	3,  // 4: kratos.api.Server.proxy:type_name -> kratos.api.Server.NetConfig
	4,  // 5: kratos.api.Data.database:type_name -> kratos.api.Data.Database
	5,  // 6: kratos.api.Data.redis:type_name -> kratos.api.Data.Redis
	6,  // 7: kratos.api.Server.NetConfig.timeout:type_name -> google.protobuf.Duration
	6,  // 8: kratos.api.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	6,  // 9: kratos.api.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
